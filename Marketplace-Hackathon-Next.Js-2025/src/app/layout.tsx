...
export const metadata: Metadata = {
  title: "BaigComfort- Modern Furniture Store",
  description:
    "Discover BaigComfort – your go-to online furniture store for premium sofas, chairs, and home decor. Shop stylish and comfortable furniture for your living space with fast delivery and great deals.",
  icons: {
    icon: "/favicon.ico",
  ...
  openGraph: {
    title: "BaigComfort - Premium Furniture for Your Home",
    description:
